...
THE TESTS
    ...
    *Acceptance test*
    These test show that the system does what is supposed to do from the business point of view. They can be viewed as testing by example. While unit tests and integration test are aware of the internal implementation, acceptance test only care about inputs and output.
